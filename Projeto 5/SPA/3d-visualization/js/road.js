...
export default class Road extends THREE.Group {
  constructor(parameters) {
    ...
    roadElement1.castShadow = true
    roadElement1.receiveShadow = true
    ...
    roadElement3.castShadow = true
    roadElement3.receiveShadow = true
    ...
    roadElement2.castShadow = true
    roadElement2.receiveShadow = true
