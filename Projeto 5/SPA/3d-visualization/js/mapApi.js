...
export default class MapApi {
  ...
  loadRoads(warehouses, callback) {
    ...
    request.onload = () => {
      ...
      if (request.status == 200) {
        ...
        console.log(listt)
        callback(listt,warehouses) //LLL THIS CAN BE A PROBLEM, was changed
      } else {
        console.log("Error: " + request.status + request.statusText)
        return []
      }
  ...
  loadBestRoute(warehouses,routes,callback){
    ...
    let json = '{ "cities": [{"address": null,"alt": 1.0,"cityId": "K03","destination": "Porto","lat": 2.0,"lng": 9.0 }, {"address": null,"alt": 1.0,"cityId": "K02","destination": "Villa Nova","lat": 2.0,"lng": 9.0},{"address": null,"alt": 1.0,"cityId": "K01","destination": "V","lat": 2.0,"lng": 9.0}],"necessaryTime": 73.96668533034715}'
